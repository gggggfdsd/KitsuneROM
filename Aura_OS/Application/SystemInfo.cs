...
namespace Aura_OS
{
    public class SystemInfo : App
    {
        ...
        {
            Kernel.canvas.DrawString("KitsuneROM [version " + Kernel.Version + "-" + Kernel.Revision + "]", Kernel.font, Kernel.BlackPen, (int)x, (int)y);
            Kernel.canvas.DrawString("Created by kirin, based on AuraOS.", Kernel.font, Kernel.BlackPen, (int)x, (int)y + (1 * Kernel.font.Height));
            Kernel.canvas.DrawString("Website: WIP", Kernel.font, GreenPen, (int)x, (int)y + (3 * Kernel.font.Height));
