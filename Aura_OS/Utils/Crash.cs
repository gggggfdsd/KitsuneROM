...
namespace Aura_OS.System
{
    public class Crash
    {
        ...
        public static void WriteException(Exception ex)
        {
            ...
            Kernel.console.WriteLine("An error occured in KitsuneROM:");
        ...
        public static void StopKernel(string exception, string description, string lastknowaddress, string ctxinterrupt)
        {
            ...
            string CpuException = "CPU Exception x" + ctxinterrupt + " occured in KitsuneROM:";
            ...
            string Version = "Version: " + Kernel.Version;
            ...
            string Revision = "Revision: " + Kernel.Revision;
